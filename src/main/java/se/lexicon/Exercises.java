...
public class Exercises {
    ...
    */
    ...
    public static void exercise4(String message) {
        System.out.println(message);
        //Predicate<Person> findBYId =(Predicate<Person>) storage.findOne(Person->Person.getId()==123);
    ...
    public static void exercise5(String message) {
        System.out.println(message);
        storage.findOneAndMapToString(person -> person.getId()==456,person -> "Name:"+person.getFirstName()+""+person.getLastName()+"Born:"+person.getBirthDate());
        //Write your code here
    ...
    public static void exercise6(String message) {
        System.out.println(message);
        storage.findManyAndMapEachToString(person -> person.getGender()==Gender.MALE && person.getFirstName().startsWith("E"),
    ...
    public static void exercise7(String message) {
        System.out.println(message);
        storage.findManyAndMapEachToString(person -> Period.between(person.getBirthDate(),LocalDate.now()).getYears()<10,
